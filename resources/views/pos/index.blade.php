            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ $item->subtotal }}</td>
                        <td>
                            <a href="{{ route('pos.deleteCart', $item->rowId) }}" class="btn btn-danger border-none" data-toggle="tooltip" data-placement="top" title="" data-original-title="Delete"><i class="ri-delete-bin-line mr-0"></i></a>
                        </td>
                    </tr>
                    @endforeach
                </tbody>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="input-group col-sm-8">
                                    ...
                                    <div class="input-group-append">
                                        ...
                                        <a href="{{ route('products.index') }}" class="input-group-text bg-danger"><i class="lar la-trash-alt"></i></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <form action="{{ route('pos.addCart') }}" method="POST"  style="margin-bottom: 5px">
                                            ...
                                            <button type="submit" class="btn btn-primary border-none" data-toggle="tooltip" data-placement="top" title="" data-original-title="Add">+</button>
                                        </form>
                                    </td>
                                </tr>
