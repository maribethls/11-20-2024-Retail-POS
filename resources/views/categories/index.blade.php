    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="d-flex flex-wrap align-items-center justify-content-between mb-4">
                ...
                <div>
                <a href="{{ route('categories.create') }}" class="btn btn-primary add-list"><i class="las la-plus"></i></i>Create Category</a>
                <a href="{{ route('categories.index') }}" class="btn btn-danger add-list"><i class="las la-minus"></i>Clear Search</a>
                </div>
            </div>
        </div>
                        ...
                        <div class="col-sm-8">
                            <div class="input-group">
                                ...
                                <div class="input-group-append">
                                    <button type="submit" class="input-group-text bg-primary"><i class="las la-search"></i></i></button>
                                </div>
                            </div>
                        </div>
                    </div>
