    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="d-flex flex-wrap align-items-center justify-content-between mb-4">
                ...
                <div>
                <a href="{{ route('users.create') }}" class="btn btn-primary add-list"><i class="las la-plus"></i>Create User</a>
                <a href="{{ route('users.index') }}" class="btn btn-danger add-list"><i class="las la-minus"></i>Clear Search</a>
                </div>
            </div>
        </div>
